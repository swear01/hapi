...
export const BUILTIN_SLASH_COMMANDS = {
    ...
    opencode: [
        { name: 'clear', description: 'Not yet supported in HAPI OpenCode sessions', source: 'builtin' },
        { name: 'compact', description: 'Not yet supported in HAPI OpenCode sessions', source: 'builtin' },
        ...
        { name: 'model', description: 'Show or set OpenCode model, e.g. /model anthropic/claude-sonnet-4-5', source: 'builtin' },
        { name: 'reasoning', description: 'Show or set reasoning effort', source: 'builtin' },
        { name: 'effort', description: 'Alias for /reasoning', source: 'builtin' },
        { name: 'permissions', description: 'Show or set permission mode', source: 'builtin' },
        { name: 'permission', description: 'Alias for /permissions', source: 'builtin' },
