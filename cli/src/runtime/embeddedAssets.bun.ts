...
import hapiSessionControlSkill from '../../skills/hapi-session-runtime/SKILL.md' with { type: 'file' };
...
const COMMON_ASSETS: EmbeddedAsset[] = [
    asset('skills/hapi-session-runtime/SKILL.md', hapiSessionControlSkill),
