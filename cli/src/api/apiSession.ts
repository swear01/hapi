...
export class ApiSessionClient extends EventEmitter {
    ...
    sendAgentMessage(body: unknown, createdAtOrLocalId?: number | string, positionAt?: number): void {
        const createdAt = typeof createdAtOrLocalId === 'number' ? createdAtOrLocalId : undefined
        const localId = typeof createdAtOrLocalId === 'string' ? createdAtOrLocalId : undefined
        const content = {
            role: 'agent',
            content: {
