...
162 current open PRs: 58 carry, 100 defer, 4 drop. All prior heads were compared with a fresh GitHub snapshot, live checks, latest-head HAPI Bot reviews, and maintainer comments. Nine heads are new or changed since v0.29.0.5.

carry: pr-1776, pr-1773, pr-1771, pr-1770, pr-1766, pr-1761, pr-1760, pr-1757, pr-1755, pr-1754, pr-1750, pr-1748, pr-1741, pr-1729, pr-1728, pr-1727, pr-1726, pr-1721, pr-1720, pr-1715, pr-1707, pr-1702, pr-1694, pr-1685, pr-1683, pr-1679, pr-1678, pr-1671, pr-1666, pr-1664, pr-1662, pr-1660, pr-1656, pr-1644, pr-1637, pr-1636, pr-1635, pr-1633, pr-1621, pr-1620, pr-1616, pr-1615, pr-1610, pr-1607, pr-1604, pr-1592, pr-1581, pr-1543, pr-1542, pr-1468, pr-1451, pr-1436, pr-1422, pr-1421, pr-1419, pr-1418, pr-1414, pr-1158.
...
## Operator exclusion of PR 1424

User-selected context: /sessions/2c3b8fb5-9070-4f8a-8d81-91ff5389b71d. Temporarily defer #1424 because stale running jobs indefinitely pin inactive sessions. Remove job CLI/MCP/API/UI and dependent running-job deletion guards, preserving unrelated native controls, schema V29, legacy job tables/rows, and reserved metadata protections. Restore ordinary active-session pinning; the old all preference maps to enabled, jobs maps to disabled. Earlier job-preservation statements above describe the prior candidate and are superseded by this exclusion.

Fresh exclusion audit: 162 open PRs; no previous PR heads changed. New #1777 at 708e8ecf502e08f4acf86f43f51d739e92e96b19 is deferred pending full spawned-child title lifecycle verification with the maintained native-runtime overlay; the clean current-head HAPI Bot review notes that gap. Final selection: 58 carry, 100 defer, 4 drop.

Exclusion verification: fresh full typecheck and complete package suite passed: CLI 2903/13 skipped, Hub 1549/3 skipped, Web 3267, Shared 329, Relay 80, Desktop 5; total 8133 passed, 16 existing skips, zero failures. Browser scroll/terminal/composer 17/17; maintenance 42/42; fixture generation leaves tracked files unchanged. Thirteen-patch rehearsal matches canonical tree 07c34544ae7435cdb1fd63c04afb848c5d462bc4 (replay commit f50dc40c2f69655ef3ce161a2461dd881ab7de9b). Local logic review verified all removed job imports/callers, retained schema/data, metadata protections, native MCP controls, and the inactive legacy-job UI regression.

Exclusion follow-up: preserve the existing non-job CLI argument normalization and Cursor ambient-thinking fixes previously bundled with #1424. Reverting those alongside Jobs reproduced two regressions: Bun entrypoint strips the selected HAPI subcommand, and idle Cursor chatter marks a quiet session as thinking. Restore those maintenance fixes without job commands, API, or UI; 61 targeted tests pass after two failing regressions. Canonical source tree 354d69d4e8b9ae94a5dd6cd0ade2276a55387f96.

Final independent-fix gate: complete typecheck and unit suite passed (CLI 2908/13 skipped, Hub 1549/3 skipped, Web 3267, Shared 329, Relay 80, Desktop 5; total 8138 passed, 16 existing skips, zero failures). Fourteen-patch rehearsal c335c6da16180f247bc2590f3f22c5a1ec1172aa matches source tree 354d69d4e8b9ae94a5dd6cd0ade2276a55387f96. Web source is unchanged from the final 17/17 browser gate.
