...
160 current open PRs: 58 carry, 98 defer, 4 drop. All prior heads were compared with a fresh GitHub snapshot, live checks, latest-head HAPI Bot reviews, and maintainer comments. Nine heads are new or changed since v0.29.0.5.
