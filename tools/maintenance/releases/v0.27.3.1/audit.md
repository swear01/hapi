...
Previous maintained release: v0.27.2.5

Official release: v0.27.3

Personal PR owner: swear01

Origin main: 1cf2293ec9a749088099e822e6a105c59c7e513b
Upstream main: fea42212ea945ff2df68cf2dad3ff1a4b508f053

## Fork-only commits

- 1cf2293ec9a749088099e822e6a105c59c7e513b docs(maintenance): merge doctrine v2 (UFR) — upstream-first rebuild, previous release as reference only
- 06370458391ae885ffc73859b0551f94d32cdec6 docs(maintenance): merge doctrine (delta-merge) — branch from previous release, merge upstream, resolve by side selection
- 62e058cb9077ad413e2de91fc80d36e1ca0e905c chore(release): v0.27.2.5 hotfix manifest
...
- #1529 [CLEAN] fix(cursor): exclusive agent spawn lease for list-models vs ACP @ 7bfdac6394222e4603d1d03b408f3d93ce2f520a (https://github.com/tiann/hapi/pull/1529)
...
- #1525 [UNSTABLE] test(cli): make the suite pass on macOS hosts @ 85e5ec888140097893bdf30dfe1b101145d2c54e (https://github.com/tiann/hapi/pull/1525)
...
- #1517 [CLEAN] Fix Telegram Mini App polish and file tree state @ d6d537ec61fd75574206df5c46effa6fff7f5717 (https://github.com/tiann/hapi/pull/1517)
...
- #1473 [CLEAN] feat(peer): attribute ping_peer deliveries with trusted provenance @ e819571bd7410575be32c10e0c389fd9e7112d8c (https://github.com/tiann/hapi/pull/1473)
...
- #1447 [CLEAN] feat(web): add separate option to pin active sessions @ 703c1adef0e967187796d6dcee0a1b0043057c21 (https://github.com/tiann/hapi/pull/1447)
- #1443 [CLEAN] feat: restore mid-turn steer for Codex and Cursor @ 75e42cdcfecd633ddeb6663bb1b8e63be9643b18 (https://github.com/tiann/hapi/pull/1443)
...
- #1429 [UNSTABLE] feat(claude): import local session history @ 1548315fbc9b48f6b60d68ad957c7151e88d3d12 (https://github.com/tiann/hapi/pull/1429)
...
- #1414 [UNSTABLE] fix(web): hide redundant machine labels on single-machine pinned rows @ c6717383c1640dc9d683e76fa0497ee5658bd7a0 (https://github.com/tiann/hapi/pull/1414)
- #1361 [CLEAN] Fix/codex sync idle active @ 6a6d45dfa4ea9b771c3b9219f6332b594743014e (https://github.com/tiann/hapi/pull/1361)
- #1360 [CLEAN] feat: add notification preferences and customizable web push copy @ 7fb80ea97b003a7bd9e07c16a5ccd866718ea6d1 (https://github.com/tiann/hapi/pull/1360)
...
- #1093 [UNSTABLE] feat(web): add assistant response navigation @ ee605858e0cfe9546597c3e87d72185ab34e8af3 (https://github.com/tiann/hapi/pull/1093)
...
- Method: upstream-first rebuild (UFR) from `upstream/main` `fea42212e`, retaining the resolved `v0.27.2.5` maintained overlay only where upstream still lacks it.
- New/current-head normal carries: #1158, #1447, #1530, #1529, plus the still-current proportional carries recorded in `pr-audit.tsv`.
- #1468 remains dropped by operator decision; #1320 remains permanently excluded.
- PRs that are dirty, failing, draft, too broad without maintainer acceptance, or missing a current-head clean review are deferred. Existing resolved behavior from `v0.27.2.5` is not silently replaced by a newer unaudited PR head.
