...
All 131 open PRs are resolved in `pr-audit.tsv`: 42 carry, 85 defer, 4 drop.
...
- #1718 remains deferred on exact-head findings. #1695 is deferred because its optional fullscreen layout invalidates fork-only cross-platform golden images. New #1719 and #1722 are deferred for common-path integration risk without maintainer acceptance; focused #1720 and #1721 are carried.
