...
Previous maintained release: v0.29.0.1

Official release: v0.29.0

Personal PR owner: swear01

Origin main: afe4c1f069e705137d93f203dd29be1833aedda1
Upstream main: 980a921ba15665c54998a6ddb658103d467ff4cb

## Fork-only commits

- afe4c1f069e705137d93f203dd29be1833aedda1 Merge pull request #11 from swear01/feat/session-uptime-statusbar
- 52eedb78172c55c66e350ddd37d039b6f3b62e7f feat(web): show machine uptime in session status bar
- 10b8dda8b87b2055454d1e34a03f8343be8c4ec6 chore(release): prepare v0.29.0.1
- 240ab2f0535eadbb0a3f51b287c7ed04f405f34a Release version 0.29.0
...
- #1693 [CLEAN] feat(web): add fullscreen table preview and export actions @ e2bb5c7f3b81fc35df95822764b3b4c3afa6fc18 (https://github.com/tiann/hapi/pull/1693)
...
- #1654 [CLEAN] fix(codex): let forked sessions resume while source stays active @ ed7c1802368f8366f315d6b46466f23b657825a7 (https://github.com/tiann/hapi/pull/1654)
...
- #1611 [CLEAN] fix(scratchlist): persist manual ordering and improve draft actions @ cf3ddb9e9630f4be7bbd1d649b56439085299bea (https://github.com/tiann/hapi/pull/1611)
...
- #1607 [CLEAN] feat(web,hub): right-click context menu for sidebar project groups (#881) @ 17d22112e96917d0ff0ffdfe95de750f571b823c (https://github.com/tiann/hapi/pull/1607)
- #1605 [CLEAN] feat(claude): discover models and context window from the CLI @ f53eb2cb66a2a6e045a2d38dbf7fedeabaecabb2 (https://github.com/tiann/hapi/pull/1605)
...
- #1543 [CLEAN] fix(web): preserve wrapped inline code backgrounds in shared images @ 2d6dbd4de8e78209d0ac06c57fc27dcc6ec8a373 (https://github.com/tiann/hapi/pull/1543)
...
- #1436 [CLEAN] feat(web): persist and send voice input message across session navigation (#1435) @ 155ec33a04b8b748279f0495ed0bd7518c98eee3 (https://github.com/tiann/hapi/pull/1436)
...
- #1093 [draft] feat(web): add assistant response navigation @ b2cbe6cc1a41f114de12371103382c55ba9efb86 (https://github.com/tiann/hapi/pull/1093)
...
All 132 open PRs are resolved in `pr-audit.tsv`: 42 carry, 86 defer, 4 drop.

Carry: #1721 #1720 #1715 #1707 #1702 #1694 #1685 #1683 #1679 #1678 #1671 #1666 #1664 #1662 #1660 #1656 #1644 #1637 #1636 #1635 #1633 #1621 #1620 #1616 #1615 #1610 #1607 #1604 #1592 #1581 #1543 #1542 #1468 #1451 #1436 #1424 #1422 #1421 #1419 #1418 #1414 #1158.

Drop: #1680 (exact-head findings), #1597/#1093 (operator-dropped response navigation), and #1091 (operator-dropped managed provider profiles). #1320 remains permanently excluded if reopened.

Special integration decisions:

- #1419 is coalesced into current #1436; there is one dictation-send contract.
- #1610 is accepted through upstream #1609. Closed #1647 is accepted through upstream #1648. Their behavior is not replayed twice.
- #1662 is a personal-policy carry with exceptional scope and no maintainer signal. Its older generic composer foundation is excluded; the semantic Copilot/Kimi effort port and latest clean exact-head follow-ups fix model/catalog binding, runtime synchronization, and AGY Auto reset persistence.
- #1468 is a personal-policy carry despite failed latest-head checks and no maintainer signal. Its corrected head replaces the old buggy revision that the operator previously dropped.
- #1725 is deferred because it depends on the absent #1717 Blocked estate UI and its exact head has a Major repeated auto-Continue finding plus a Minor Unicode truncation finding. #1718 remains deferred on exact-head findings. #1695 is deferred because its optional fullscreen layout invalidates fork-only cross-platform golden images. New #1719 and #1722 are deferred for common-path integration risk without maintainer acceptance; focused #1720 and #1721 are carried.
- Current #987 and #1360 heads are deferred. Model-error detection, banner, and notifications plus prior notification preferences remain grandfathered baseline behavior; unfinished manual/automatic Bridge controls are removed. The old #1447 boolean pin-active path is removed in favor of #1424's tri-state control.
