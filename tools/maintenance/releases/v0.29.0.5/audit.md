...
Previous maintained release: v0.29.0.4

Official release: v0.29.0

Personal PR owner: swear01

Origin main: dbd150922d491b3e126725c1eb1a8b5c26714d82
...
- #1753 [CLEAN] fix(runner): reject a spawn model missing from the machine's catalog @ 9dc0d41826008169ed2ecef3d83b31f60d9c553e (https://github.com/tiann/hapi/pull/1753)
...
All 154 open PRs are resolved in `pr-audit.tsv`: 54 carry, 96 defer, 4 drop.

Carry: #1761 #1760 #1757 #1755 #1754 #1750 #1748 #1741 #1729 #1728 #1727 #1726 #1721 #1720 #1715 #1707 #1702 #1694 #1685 #1683 #1679 #1678 #1671 #1666 #1664 #1662 #1660 #1656 #1644 #1637 #1636 #1635 #1633 #1621 #1620 #1616 #1615 #1610 #1607 #1604 #1592 #1581 #1543 #1542 #1468 #1451 #1436 #1424 #1422 #1421 #1419 #1418 #1414 #1158.
...
Compared with `v0.29.0.4`, only draft #1762 is new. The other 153 open PR heads and live mechanical statuses are unchanged and retain their reviewed decisions, except #1741 is now carried by explicit operator ruling.

- Carry #1741 at exact head `c22780ba5588340ff2813f9e139f2abaa35f7e65`: stable `streamId`-based reasoning/text block identity fixes the live Pi first-reasoning flicker across Web, iOS, and Android. The operator explicitly accepts the same exact head's title-provider max-token and timeout controls.
- Defer #1762: the 77-file, 6,483-addition in-session search change is still a draft.
- All prior special integration, personal-policy exception, defer, and drop decisions remain unchanged.
...
- Playwright: terminal-wrap and platform-native composer copy passed 7/7.
- Runner integration: 13 passed and one unsupported-platform case skipped.
- Maintenance tests: 42/42 passed.
- Fixtures: all 49 chat, 12 SSE, 12 pagination, and catalog/mode fixtures regenerated with zero drift.
- Native gates: upstream #1741's exact head has clean Android and iOS CI. Local Android assembly could not start because this production runner has no Android SDK; local source smoke was correctly refused by the `swever` production-host guard. Candidate Android and iOS CI remain mandatory publication gates.
- Build: `build:single-exe:all` completed for darwin x64/arm64, Linux x64/arm64, and Windows x64 with Bun runtime 1.4.0. The Linux-arm64 binary starts, prints help, and reports HAPI 0.29.0.5.

Release status: local candidate ready for exact-head PR review and CI publication gates.
