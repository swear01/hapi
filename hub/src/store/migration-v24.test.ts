...
describe('Store V23->V24 migration: notification preferences', () => {
    it('creates notification preferences for an existing V23 database', () => {
        const directory = mkdtempSync(join(tmpdir(), 'hapi-migration-v23-to-v24-'))
