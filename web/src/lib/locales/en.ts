export default {
  ...
  'settings.general.sessionSummary.description': 'Control whether stored status summaries appear in chat and copied content.',
  ...
  'session.summary.status.stalled': 'Stalled',
    ...
    'settings.storage.breakdownShare': 'Share',
    'settings.storage.breakdownSize': 'Size',
    'settings.storage.freelist': 'Reclaimable free pages',
    ...
    'settings.storage.used': 'Data',
    'settings.storage.vacuum': 'Compact now',
    'settings.storage.vacuumConfirm': 'Run VACUUM on the hub database now? Hub writes will briefly pause while the file is compacted.',
    'settings.storage.vacuumDone': 'Reclaimed {size} ({before} → {after})',
    'settings.storage.vacuumError': 'Compaction failed: {message}',
    'settings.storage.vacuumHint': 'Rebuilds the database file and returns reclaimable free pages to disk. Hub writes briefly pause while compacting.',
    'settings.storage.vacuumTitle': 'Compact database',
    'settings.storage.vacuuming': 'Compacting…',
