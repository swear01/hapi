export default {
  ...
  'settings.display.create': 'Create form',
  'settings.display.create.description': 'Choose which selections appear when creating a session.',
  'settings.display.create.machine': 'Show machine selection',
  'settings.display.create.sessionType': 'Show session type selection',
  'settings.display.create.agent': 'Show agent selection',
  'settings.display.create.model': 'Show model selection',
  'settings.display.create.effort': 'Show effort selection',
  'settings.display.create.reasoningEffort': 'Show reasoning effort selection',
  'settings.display.create.grokPermissionMode': 'Show Grok permission mode',
  'settings.display.create.codexFamilyPermissionMode': 'Show permission mode',
  'settings.display.create.collaborationMode': 'Show collaboration mode',
  'settings.display.create.copilotAgentMode': 'Show Copilot agent mode',
  'settings.display.create.fastMode': 'Show fast mode',
  'settings.display.create.yolo': 'Show YOLO mode',
