export default {
  ...
  'settings.general.sessionSummary.description': '控制已存储的状态摘要是否显示在聊天和复制内容中。',
  ...
  'session.summary.status.stalled': '已停滞',
    ...
    'settings.storage.breakdownShare': '占比',
    'settings.storage.breakdownSize': '大小',
    'settings.storage.freelist': '可回收空闲页',
    ...
    'settings.storage.used': '数据',
    'settings.storage.vacuum': '立即压缩',
    'settings.storage.vacuumConfirm': '现在对 Hub 数据库执行 VACUUM 压缩？压缩期间 Hub 写入会短暂暂停。',
    'settings.storage.vacuumDone': '已回收 {size}（{before} → {after}）',
    'settings.storage.vacuumError': '压缩失败：{message}',
    'settings.storage.vacuumHint': '重建数据库文件，把可回收的空闲页归还磁盘。压缩期间 Hub 写入会短暂暂停。',
    'settings.storage.vacuumTitle': '清理并压缩数据库',
    'settings.storage.vacuuming': '正在压缩…',
