export default {
  ...
  'settings.display.create': '创建表单',
  'settings.display.create.description': '选择创建会话时要显示的选项。',
  'settings.display.create.machine': '显示机器选择',
  'settings.display.create.sessionType': '显示会话类型选择',
  'settings.display.create.agent': '显示 Agent 选择',
  'settings.display.create.model': '显示模型选择',
  'settings.display.create.effort': '显示强度选择',
  'settings.display.create.reasoningEffort': '显示推理强度选择',
  'settings.display.create.grokPermissionMode': '显示 Grok 权限模式',
  'settings.display.create.codexFamilyPermissionMode': '显示权限模式',
  'settings.display.create.collaborationMode': '显示协作模式',
  'settings.display.create.copilotAgentMode': '显示 Copilot Agent 模式',
  'settings.display.create.fastMode': '显示快速模式',
  'settings.display.create.yolo': '显示 YOLO 模式',
